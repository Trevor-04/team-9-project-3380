...
function Signup() {
    ...
    const handleSubmitForm = async (formData) => {
        try {
            ...
            const newMember = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/members/new/member`, memberData);
            ...
            await axios.post(`${process.env.REACT_APP_BACKEND_URL}/members/new/login`, accountData);
            navigate('/login');
