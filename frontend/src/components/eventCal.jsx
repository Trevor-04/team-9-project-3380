...
async function getAllEvents() {
  await axios.get(`${process.env.REACT_APP_BACKEND_URL}/events/`)
  .then(response => {
    const eventsByDate = {};
  ...
  const handleAddEvent = async (e) => {
    ...
    try {
      await axios.post(`${process.env.REACT_APP_BACKEND_URL}/events/add/`, newEvent);
  ...
  const handleDeleteEvent = async () => {
    try {
      await axios.post(`${process.env.REACT_APP_BACKEND_URL}/events/delete/`, { eventID: selectedEvent.eventID });
