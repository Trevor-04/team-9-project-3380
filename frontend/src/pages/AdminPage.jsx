    ...
    return (
      <div>
        ...
        <div className="sales text-[#165e229e] w-full bg-white p-6 rounded-lg shadow-sm">
          <div className="flex items-center"> {/* Icon and title horizontally aligned */}
          <h3>Sales this week</h3> {/* Title to the right of the icon */}
            ...
            <p className="mt-2">{sales}</p> {/* Text below the title */}
          </div>
